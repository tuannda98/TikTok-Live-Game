...
### Step 2: Summarize the plans and document them with `/apw:journal` skill invocation
...
- Use Task tool with `subagent_type="apw:journal-writer"` in parallel to document all plans.
