...
| `scripts/smoke-test.sh` | End-to-end smoke test (no server required) — `bash claude/skills/use-mcp/scripts/smoke-test.sh` (Unix/macOS only — on Windows, run from WSL or Git Bash) |
