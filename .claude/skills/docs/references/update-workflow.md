...
3. Activate `apw:scout` skill to explore the code base and return detailed summary reports
...
**CRITICAL:** You MUST spawn `apw:docs-manager` agent via Task tool with merged reports and doc readings.
