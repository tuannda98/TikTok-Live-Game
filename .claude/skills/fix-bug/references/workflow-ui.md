...
Analyze screenshots/videos with `apw:ai-multimodal` skill.
...
Use `agent-browser`, Chrome MCP / `chrome-devtools-mcp`, or project-native browser tests.

`TaskUpdate(T4, status="completed")`

### Step 5: Test
`TaskUpdate(T5, status="in_progress")`
Use `apw:tester` agent for compilation check.
